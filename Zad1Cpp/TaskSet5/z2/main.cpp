...
auto main() -> int {
	Meteo stacja;
	std::unique_ptr<Obserwator> p1(new Monitor("Monitor 1", stacja));
	std::unique_ptr<Obserwator> p2(new Monitor("Monitor 2", stacja));
	std::unique_ptr<Obserwator> p3(new MonitorSredni("Monitor Sredni 1", stacja));
	std::unique_ptr<Obserwator> p4(new MonitorSredni("Monitor Sredni 2", stacja));
